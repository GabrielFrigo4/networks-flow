...
\centering
\begin{tikzpicture}[thick]
  \draw[layer line] (-2, 0) -- (6.2, 0) node[right,black,font=\footnotesize] {$h=0$ (sumidouro $t$)};
  \foreach \y/\h in {1.3/1, 2.6/2, 4.8/4} {
    \draw[layer line] (-2, \y) -- (6.2, \y) node[right,black,font=\footnotesize] {$h=\h$};
  }
  \draw[red!50,dashed,line width=1.5pt] (-2, 3.7) -- (6.2, 3.7) node[right,red!80!black,font=\footnotesize] {$h=3$ (\textbf{LACUNA})};
