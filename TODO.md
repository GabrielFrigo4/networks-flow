...
- [x] Arrumar as Imagens dos Grafos do Push Relabel, Kong e nas Conclusões (textos ficaram sobrepostos e ficaram esquisitos e não limpos ou simplesmente a imagem está só errada, como o caso do emparelhamento, que 2 arestas tem o mesmo vertice...)
- [x] Adicionar mais Imagens nas Explicações e nas Teorias, Para deixar mais visual essa iniciação cientifica
- [x] Arrumar 5.10.2 Segmentação via Corte Mínimo, o texto parece ter uma repetição do corte...
- [x] Possivelmente arrumar o nome que aparece no ic.tex ou ver o que da para fazer para ficar legal, considerando que o ic.tex tem como objetivo ser um PDF para eu poder enviar caso alguem queira saber sobre a minha IC
- [ ] Pedir depois para o Gemini Pro dar uma geral COMPLETA no LaTeX, ler tudo tintin pot tintin, tanto gramaticalmente, como a qualidade da explicação, o fluxo de leitura, as imagens e suas corretudes... Enfim tudo, inclusive as referencias e bibliografias
